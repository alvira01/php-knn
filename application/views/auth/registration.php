...
<head>
    ...
    <title>SagaApp-Registrasi</title>
...
<body class="bg-gradient-primary">
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-3 col-lg-6 mx-auto"> <!--mx adalah margin kiri kanan-->
                        ...
                        <div class="p-5">
                            ...
                            <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="nis" name="nis"
                                        placeholder="NIS" value="<?= set_value('nis');?>">
